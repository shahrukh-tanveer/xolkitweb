  ...
  return (
    <section className="py-6 max-w-3xl mx-auto my-14">
      ...
      <form className="mt-6 grid grid-cols-1 gap-4">
        ...
        <button type="button" className="w-max mx-auto mt-2 inline-flex items-center rounded-lg bg-brand px-5 py-3 text-white font-semibold shadow hover:bg-brand-dark">Send inquiry</button>
