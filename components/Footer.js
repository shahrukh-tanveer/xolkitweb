    ...
    <footer className="mt-20 border-t border-gray-100">
      <div className="container-px py-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-sm">
        <div>
          ...
          <p className="mt-2 text-gray-600">We craft digital products and AI solutions that move the needle.</p>
        </div>
        <div>
      ...
      <div className="container-px py-6 border-t border-gray-100 text-xs text-gray-500 flex flex-col sm:flex-row items-center justify-between">
